...
public class ParentCancelAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_cancel_appointment);
                ...
                databaseReference.updateChildren(data, new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                        if(error == null){
                            ...
                            Intent intent=new Intent(ParentCancelAppointmentActivity.this, ParentshomepageActivity.class);
