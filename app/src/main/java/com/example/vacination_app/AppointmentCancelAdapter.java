...
public class AppointmentCancelAdapter  extends RecyclerView.Adapter<AppointmentCancelAdapter.ViewHolder>{

    private List<AppointmentDisplay> listData;
    private Context mContext ;

    public AppointmentCancelAdapter(Context mContext,List<AppointmentDisplay> listData) {
    ...
    @NonNull
    @Override
    public AppointmentCancelAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_child,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AppointmentCancelAdapter.ViewHolder holder, int position) {
